                  ...
                  >
                    ...
                    {unreadCount > 0 && (
                      <Badge
                        variant="danger"
                        size="sm"
                        className="min-w-[20px] h-5 flex items-center justify-center absolute right-2 top-1/2 transform -translate-y-1/2"
                      >
                  ...
                  >
                    ...
                    {unreadCount > 0 && (
                      <Badge
                        variant="danger"
                        size="sm"
                        className="min-w-[20px] h-5 flex items-center justify-center absolute -top-1 -right-1"
                      >
                        {unreadCount > 99 ? '99+' : unreadCount}
                      </Badge>
                    )}
